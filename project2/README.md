...
- The site displays using `npm install`, `node server.js` as described
  - Minor issues are treated as Additional Requirements, but you fail this requirement if you fail to show you were trying to work as intended.
