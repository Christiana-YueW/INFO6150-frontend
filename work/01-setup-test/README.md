...
**Due: Mon May 12, 11:59pm ** 

EXCEPTION: If you joined the class after the first week, you will need to complete this assignment but the due date is Mon May 19, 11:59pm , same as the second assignment.  I highly encourage you complete this assignment as soon as possible, and as a courtesy to the TA, mention in the PR description that you joined the class late.
...
- Each requested detail (github username, name, etc) must be accurate (each detail is a separate requirement)
- Each requested detail (github username, name, etc) must have the requested class name (each detail is a separate requirement)
